...
const Categorys = () => {
  ...
  return (
    <div>
      <Header></Header>
    <div className='bg-[#070720] text-white font-sans'>
    <div className="container mx-auto p-4">
  
  <div className="text-center mb-6">
    <h1 className="text-2xl font-bold">Phim Đang Chiếu</h1>
   {Array.isArray(categories) && categories.map((category:ICategoryMovie)=>(
     <div className="flex justify-center mt-4 space-x-4" key={category.id}>
     <button className="px-4 py-2 bg-red-600 rounded-md">{category.name_category}</button>
